    ...
    <div className=" shopping-container">
...

      {
        data.map((element, index)=>{
          return   <ShopEquipmentCard title={element.title} content={element.content} price={element.price} buttonContent={element.buttonContent} imageUrl={element.imageUrl} subscriptionMessage={element.subscriptionMessage} isFinalAndOdd={index===data.length-1 && index%2===0} />
